        ...
        <div class="col-md-12">
            <div class="panel panel-flat">
                <div class="panel-heading">
                    <h5 class="panel-title"> {{__('productmedia.edit')}} {{$item['name_'.app()->getLocale()]}}</h5>
                ...
                <div class="panel-body">
                            {!!Form::model($item , ['route' => ['dashboard.product.productmedia.update' , [$parent->id , $item->id]] ,'class'=>'phone_validate myform','method' => 'PATCH','files'=>true]) !!}
