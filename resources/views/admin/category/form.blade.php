...
<div class="form-group col-md-12 pull-left">
    <label>{{__('category.name_ar')}} </label> <span class="label bg-danger help-inline">{{__('Required')}}</span>

    {!! Form::text("name_ar",null,['class'=>'form-control ','placeholder'=> __('category.name_ar') ])!!}
    <div class="bg-info"></div>
</div>

<div class="form-group col-md-12 pull-left">
    <label>{{__('category.name_en')}} </label> <span class="label bg-danger help-inline">{{__('Required')}}</span>

    {!! Form::text("name_en",null,['class'=>'form-control ','placeholder'=> __('category.name_en') ])!!}
    <div class="bg-info"></div>
</div>
