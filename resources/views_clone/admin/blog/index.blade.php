...
<li class="active">  <a href="{{route('dashboard.all-setting')}}">{{__('all-setting')}}</a></li>
            ...
            @foreach($items as $key=>$item)
                <tr>
                    ...
                    <td>
                        ...
                        <a href="{{route('dashboard.blog.comments.index',[$item])}}" data-toggle="tooltip" data-original-title="تعديل"> <i class="fa fa-comments text-inverse" style="margin-left: 10px"></i> </a>
                        @endcan
                        @can('dashboardblogs_edit')
                            
                        <a href="{{route('dashboard.blog.edit',[$item])}}" data-toggle="tooltip" data-original-title="تعديل"> <i class="icon-pencil7 text-inverse" style="margin-left: 10px"></i> </a>
                        @endcan
