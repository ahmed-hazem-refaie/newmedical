...
<head>
    ...
    <script type="text/javascript" src="{{asset('admin/assets2/js/pages/login.js')}}"></script>
    <!-- /theme JS files -->
<style>
    .fill-primary {
...
<body class="login-container" style="background-image: linear-gradient(rgba(255,255,255,1), rgba(255,255,255,1));  ;margin-bottom: 30px;">
                ...
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <div class="panel panel-body login-form">
                        <div class="text-center">
                            <div class="text-danger text-blue">
                                ...
                                <span class="u-header__navbar-brand-text">Nile Tours</span>
                            </div>
                        ...
                        <div class="form-group">
                            <button type="submit" class="btn bg-blue btn-block" style="   background-color: #297cbb;">تسجيل دخول <i class="icon-circle-left2 position-right"></i></button>
                        </div>
                        <span class="help-block text-center no-margin">جميع الحقوق محفوظة  <a href="http://#">شركة    حلول تيك </a></span>
                    </div>
                </form>
                <!-- /advanced login -->
