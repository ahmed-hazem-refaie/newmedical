...
<div class="form-group col-md-12 pull-left">
    <label>{{__('productfaq.title')}} </label>  <span class="label bg-danger help-inline">{{__('Required')}}</span>

    {!! Form::text("title",null,['class'=>'form-control ','placeholder'=>   __('productfaq.title') ])!!}
    ...
    <div class="panel panel-white">
        ...
        <div id="collapseTwo" class="panel-collapse collapse  " role="tabpanel" aria-labelledby="heading2">
            <div class="panel-body">
                ...
                <div class="form-group col-md-12 pull-left">
                    <label>{{__('productfaq.seo_title')}} </label>  <span class="label bg-danger help-inline">{{__('Required')}}</span>
                
                    {!! Form::text("seo_title",null,['class'=>'form-control ','placeholder'=>   __('productfaq.seo_title') ])!!}
                
                </div>
                
    
                <div class="form-group col-md-12 pull-left">
                    <label>{{__('productfaq.seo_description')}} </label>  <span class="label bg-danger help-inline">{{__('Required')}}</span>
                    
                    {!! Form::text("seo_description",null,['class'=>'form-control ','placeholder'=>   __('productfaq.seo_description') ])!!}
                ...
                <div class="form-group col-md-12 pull-left">
                    <label>{{__('productfaq.seo_keywords')}} </label>  <span class="label bg-danger help-inline">{{__('Required')}}</span>
                
                    {!! Form::text("seo_keywords",null,['class'=>'form-control form-tags-1','placeholder'=>   __('productfaq.seo_keywords') ])!!}
