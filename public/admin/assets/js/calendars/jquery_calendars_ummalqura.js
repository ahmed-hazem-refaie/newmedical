    ...
    $.extend(UmmAlQuraCalendar.prototype, {
        ...
        regionalOptions: { // Localisations
            '': {
                name: 'Umm al-Qura',
                epochs: ['BH', 'AH'],
                monthNames: ['المحرم', 'صفر', 'ربيع أول', 'ربيع ثاني', 'جماد أول', 'جماد ثاني',
                    'رجب', 'شعبان', 'رمضان', 'شوال', 'ذو القعدة', 'ذو الحجة'],
                monthNamesShort: ['محرم', 'صفر', 'ربيع أول', 'ربيع ثاني', 'جماد1', 'جماد2', 'رجب', 'شعبان', 'رمضان', 'شوال', 'ذو القعدة', 'ذو الحجة'],
