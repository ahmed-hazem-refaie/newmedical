...
class SliderController extends Controller
{
   ...
   public function store(Request $request)
   {
    ...
    // $validator = Validator::make($request->all() , [
        ...
        'sm_text_en'=>'required|string|min:2|max:200',
        'sm_text_ar'=>'required|string|min:2|max:200',
        'lg_text_ar'=>'required|string|min:2|max:200',
        'lg_text_en'=>'required|string|min:2|max:200',
   ...
   public function update(Request $request, Slider $Slider)
   {
    ...
    $this->validate($request , [
        ...
        'sm_text_en'=>'nullable|string|min:2|max:200',
        'sm_text_ar'=>'nullable|string|min:2|max:200',
        'lg_text_ar'=>'nullable|string|min:2|max:200',
        'lg_text_en'=>'nullable|string|min:2|max:200',
